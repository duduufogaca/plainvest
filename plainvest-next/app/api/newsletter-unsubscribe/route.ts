...
<head>
  ...
  <style>
    ...
    .card { max-width:420px; text-align:center; padding:40px 32px; background:#0b1929; border-radius:20px; border:1px solid rgba(0,212,170,.1); border-top:3px solid #12E3C0; }
    ...
    a { display:inline-block; background:#12E3C0; color:#02111F; font-size:14px; font-weight:900; padding:12px 28px; border-radius:10px; text-decoration:none; }
  </style>
</head>
<body>
  <div class="card">
