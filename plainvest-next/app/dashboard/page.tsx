...
const T = {
  en: {
    ...
    proDesc: 'Everything in Premium — plus a live portfolio tracker, future projections, and the full calculator suite: 6 Pro tools (simulator, retirement, DCA, ETF, inflation, financial freedom).',
    proPrice: 'AUD $9.90',
    ...
    upgradeGains: [
      ...
      'Calculator suite — 6 Pro tools: simulator, retirement, DCA, ETF, inflation & freedom',
  ...
  pt: {
    ...
    proDesc: 'Tudo do Premium — mais rastreamento de portfólio, projeções futuras e o conjunto completo de calculadoras: 6 ferramentas Pro (simulador, aposentadoria, DCA, ETF, inflação e liberdade financeira).',
    proPrice: 'AUD $9,90',
    ...
    upgradeGains: [
      ...
      'Conjunto de calculadoras — 6 ferramentas Pro: simulador, aposentadoria, DCA, ETF, inflação e liberdade',
    ...
    features: [
      ...
      'Conjunto de calculadoras — 6 ferramentas Pro',
