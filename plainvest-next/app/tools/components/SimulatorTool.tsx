...
export function SimulatorTool({ currency, rates, lang }: Props) {
  const t = TOOLS_T[lang]; const s = t.simulator;
      ...
      <div className="tool-grid">
        ...
        <div className="tool-result-col">
          <div className="tool-result portfolio-card">
            ...
            <span className="tool-result-sub">{s.rContribute} {fmtCurrency(contributed, currency)} · {s.rGrowth} {fmtCurrency(Math.max(0, value - contributed), currency)}</span>
          </div>
